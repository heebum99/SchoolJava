...
public class 예제Q6_5 {
    public static void main(String[] args) {
        ...
        System.out.println(Integer.toHexString(28)); //정수 28을 16진수 문자열로
        System.out.println(Integer.toBinaryString(28)); //정수 28을 2진수 문자열로
        ...
        System.out.println(Boolean.toString(b)); //true => "true"
